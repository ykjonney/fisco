...
class client_config:
    ...
    # --------------------------------------
    # configure below
    contract_info_file = os.path.join(settings.SITE_ROOT, "bin", "contract.ini")
    account_keyfile_path = os.path.join(settings.SITE_ROOT, "bin", "accounts")
    logdir = os.path.join(settings.SITE_ROOT, "bin", "logs")
    channel_ca = os.path.join(settings.SITE_ROOT, "bin", "ca.crt")
    channel_node_cert = os.path.join(settings.SITE_ROOT, "bin", "sdk.crt")
    channel_node_key = os.path.join(settings.SITE_ROOT, "bin", "sdk.key")
